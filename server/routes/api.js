...
var jobHistoryRouter = require('./jobHistory.routes')
...
var applicationTypeRouter = require('./applicationType.routes')
var attendanceRouter = require('./attendance.routes')
...
router.use('/jobHistory', jobHistoryRouter)
